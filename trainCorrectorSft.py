...
def TemplateGeneratorTrainer(args):
    df = pd.read_json(args.train_corrector_path)
...
def main():
    ...
    parser.add_argument('--train_corrector_path', default="./outputData/WQ/trainCorrector.json")
    parser.add_argument('--model_path', default="/data/rym/premodel/Meta-Llama-3-8B-Instruct/")
    parser.add_argument('--lora_name', default="DraftCorrector")
